<%@ Page Title="user" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Crowd.Web.user.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Gschool" HeaderText="Gschool" SortExpression="Gschool" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Dschool" HeaderText="Dschool" SortExpression="Dschool" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="company" HeaderText="company" SortExpression="company" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="describe" HeaderText="describe" SortExpression="describe" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="location" HeaderText="location" SortExpression="location" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="profession" HeaderText="profession" SortExpression="profession" ItemStyle-HorizontalAlign="Center"  /> 
