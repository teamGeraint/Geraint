...
namespace Crowd.DAL
{
    ...
    public partial class userinfo
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Crowd.Model.userinfo model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into userinfo(");
            strSql.Append("userID,userName,userPwd,userEmail,birthday,sex,Gschool,Dschool,company,describe,location,profession,headImg)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@headImg", SqlDbType.Int,4)};
            ...
            parameters[12].Value = model.headImg;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Crowd.Model.userinfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Crowd.Model.userinfo GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,userID,userName,userPwd,userEmail,birthday,sex,Gschool,Dschool,company,describe,location,profession,headImg from userinfo ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
            ...
            Crowd.Model.userinfo model = new Crowd.Model.userinfo();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["headImg"] != null && ds.Tables[0].Rows[0]["headImg"].ToString() != "")
                {
                    model.headImg = int.Parse(ds.Tables[0].Rows[0]["headImg"].ToString());
                }
                return model;
            }
            else
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,userID,userName,userPwd,userEmail,birthday,sex,Gschool,Dschool,company,describe,location,profession,headImg ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,userID,userName,userPwd,userEmail,birthday,sex,Gschool,Dschool,company,describe,location,profession,headImg ");
            strSql.Append(" FROM userinfo ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
