...
namespace Crowd.DAL
{
	...
	public partial class collect
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "collect"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from collect");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Crowd.Model.collect model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into collect(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Crowd.Model.collect model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update collect set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from collect ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Crowd.Model.collect GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,userID,publishID from collect ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
