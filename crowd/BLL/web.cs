...
namespace Crowd.BLL
{
	...
	{
		private readonly Crowd.DAL.web dal=new Crowd.DAL.web();
		public web()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Crowd.Model.web GetModelByCache(int id)
		{
			
			string CacheKey = "webModel-" + id;
			...
			return (Crowd.Model.web)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Crowd.Model.web> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Crowd.Model.web> DataTableToList(DataTable dt)
		{
			List<Crowd.Model.web> modelList = new List<Crowd.Model.web>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Crowd.Model.web model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Crowd.Model.web();
